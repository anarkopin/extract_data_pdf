...
function Register() {
    ...
    const handleSubmit = (e) => {
        ...
        //acceder a los valores del formulario via name
        ...
        AuthService.register(first_name, last_name, email, password, password_confirmation)
        .then(() => {
    ...
    <section className="bg-white">
        ...
        <div className="w-96 flex justify-center absolute">
            ...
            <div className="w-96 flex justify-center absolute">
                 <SuccessAlert active={success} message={message} handleChangeError={handleChangeSuccess} />
